...
class Index extends React.PureComponent<{}, {}> {
  ...
  public increment() {
    return action("LOAD_INCREMENT", IncrementInfo.value);
  }

  public decrement() {
    return action("LOAD_DECREMENT", IncrementInfo.value);
  }

  public incrementAsync() {
    return action("LOAD_INCREMENT_ASYNC", IncrementInfo.value);
  }
  public render() {
